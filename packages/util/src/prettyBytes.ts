/*
  Credit to: https://github.com/sindresorhus/pretty-bytes

  this was made because that package is a CommonJS module, and I don't want to change all of my project for that
