			...
			options: [
				{
					...
					...getLocalizedProp(
						'description',
						'commands.config.admin-role.description'
					),
					...
					options: [
						{
							...getLocalizedProp(
								'name',
								'commands.config.admin-role.add.name'
							),

							...getLocalizedProp(
								'description',
								'commands.config.admin-role.add.description'
							),
							...
							options: [
								{
									...getLocalizedProp(
										'name',
										'commands.config.admin-role.add.role.name'
									),
									...getLocalizedProp(
										'description',
										'commands.config.admin-role.add.role.description'
									),
						...
						},
						{
							...getLocalizedProp(
								'name',
								'commands.config.admin-role.remove.name'
							),
							...getLocalizedProp(
								'description',
								'commands.config.admin-role.remove.description'
							),
							type: ApplicationCommandOptionType.Subcommand,
							options: [
								{
									...getLocalizedProp(
										'name',
										'commands.config.admin-role.remove.role.name'
									),
									...getLocalizedProp(
										'description',
										'commands.config.admin-role.remove.role.description'
									),
									type: ApplicationCommandOptionType.Role,
									required: true
								}
						...
						},
						{
							...getLocalizedProp(
								'name',
								'commands.config.admin-role.list.name'
							),
							...getLocalizedProp(
								'description',
								'commands.config.admin-role.list.description'
							),
							type: ApplicationCommandOptionType.Subcommand
						}
					]
				},
				{
					...
					...getLocalizedProp(
						'description',
						'commands.config.mod-role.description'
					),
					type: ApplicationCommandOptionType.SubcommandGroup,
					options: [
						{
							...
							...getLocalizedProp(
								'description',
								'commands.config.mod-role.add.description'
							),
							type: ApplicationCommandOptionType.Subcommand,
							options: [
								{
									...getLocalizedProp(
										'name',
										'commands.config.mod-role.add.role.name'
									),
									...getLocalizedProp(
										'description',
										'commands.config.mod-role.add.role.description'
									),
									type: ApplicationCommandOptionType.Role,
									required: true
								}
						...
						},
						{
							...getLocalizedProp(
								'name',
								'commands.config.mod-role.remove.name'
							),
							...getLocalizedProp(
								'description',
								'commands.config.mod-role.remove.description'
							),
							type: ApplicationCommandOptionType.Subcommand,
							options: [
								{
									...getLocalizedProp(
										'name',
										'commands.config.mod-role.remove.role.name'
									),
									...getLocalizedProp(
										'description',
										'commands.config.mod-role.remove.role.description'
									),
									type: ApplicationCommandOptionType.Role,
									required: true
								}
						...
						},
						{
							...
							...getLocalizedProp(
								'description',
								'commands.config.mod-role.list.description'
							),
							type: ApplicationCommandOptionType.Subcommand
						}
					]
					...
					switch (subcommand) {
						case 'add': {
							...
							await c
								...
								.addSpecialRole(interaction.guild.id, roleId, action)
							return await interaction.editReply({
								embeds: [
									{
										...getBaseEmbed(interaction),
						...
						case 'remove': {
							...
							await c
								.resolve(configManager)
								.removeSpecialRole(interaction.guild.id, roleId, action)
							return await interaction.editReply({
								embeds: [
									{
										...getBaseEmbed(interaction),
