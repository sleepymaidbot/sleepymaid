...
To activate the timer you need to put a coin on the number 32 of each table.
...
<img src="/assets/guide/casino/roulette/screen.png" width="721" alt="The screen." />

Some numbers will appear as purple instead of white these are good numbers that need to have a coin on them at the first table. 4 numbers will be good. 32 need to stay all time on the second table.
...
<img src="/assets/guide/casino/maindoor/cardreader.png" wight="721" alt="The card reader." />
...
<img src="/assets/guide/casino/lasers/2midlasers.png" width="721" alt="The middle lasers." />
...
ℹ️Info: Middle lasers might be split in 2.
...
ℹ️Example: Middle code: 1342 and control room code: 2431 the first number from the middle code is 1 and from the control room code 2 so that means that the number one will be the second button the activate.
...
Laserfull - For finding how to decode the code.
...
Then you need to slide the key card in the key card reader in the control room.
...
At the same time, the third floor cam will be available in security room. The button to view the third floor cam changes after every sequence of color. It will put you on a random cam and the button will be randomized again. An order will be shown on a screen.
