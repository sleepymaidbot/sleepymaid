...
Some numbers will appear as purple instead of white these are good numbers that need to have a coin on them at the first table.<br/> 4 numbers will be good. The coin on 32 need to stay all time on the second table. <br/>
